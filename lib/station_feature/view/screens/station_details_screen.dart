import 'package:flutter/material.dart';
                  ...
                  class StationDetailsScreen extends StatelessWidget {
                    ...
                    Widget build(BuildContext context) {
                      ...
                      // Parse latitude and longitude into a LatLng object
                      final LatLng location = LatLng(
                        double.parse(station['latitude']?.toString() ?? '0.0'),
                        double.parse(station['longitude']?.toString() ?? '0.0'),
                      );
                        ...
                        child: Scaffold(
                          ...
                          body: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                // Pass the LatLng object to GoogleMapWidget
                                GoogleMapWidget(
                                  location: location,
                                ),
